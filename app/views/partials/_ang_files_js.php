            ...
            compile: function compile(tElement, tAttrs) {
                ...
                angular.forEach(tr.children('td'), function(elm) {
                    var column = angular.element(elm),
                        ...
                        dSort = column.attr('data-sort');
                        if (dSort == "no"){
                            headerRow.append('<th class="no-sort ui-state-default" name="' + name + '"' + filterAttrib + '" style="cursor: pointer;width: ' + width + 'px; font-weight:bold"><span style="display:inline-block">  </span>' + title + '</th>');
                ...
                return {
                    pre: function(scope, linkElement) {
                        ...
                        angular.forEach(linkElement.children('thead').children('tr').children('th'), function(elm) {
                            if (angular.element(this).hasClass('no-sort')){
                                console.log("true");
                                return;
                            } else {
