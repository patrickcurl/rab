...
<div class="row"><div class="col-xs-4">
					...
					<img src="<?php if ($book->image_url) {echo $book->image_url; } else {echo URL::asset('img/no_image.png'); } ?>"  class="img-thumbnail img-responsive" ></div>
					<div class="col-xs-7" style="padding-top:40px;"><span style="color:rgb(201, 90, 90);font-size:16px;">Buyback Price:</span> <span style="color:#317EAC;font-size:16px;font-weight:bold;">{{ $price }}</span></div>
					</div>
