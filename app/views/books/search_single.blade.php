			...
			@foreach ($books as $index => $book)
				...
				<div class="well" style="margin:10px;padding:10px;background-color: rgb(139, 139, 66)">
					...
					<div class="row">
						...
						<div class="col-xs-7" style="padding-top:40px;"><span style="color:rgb(255, 245, 0);font-size:16px;">Buyback Price:</span> <span style="color:#06FF56;font-size:16px;font-weight:bold;">{{ $price }}</span>
						</div>
					</div>
