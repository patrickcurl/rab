		...
		<tbody>
			...
			<tr>
              ...
              <img src="{{ $book->image_url }}" class="img-responsive col-md-3" style="width:100px;" />
			    ...
			    <td><input type="hidden" name="item[{{$index}}][price]" value="{{$book->retailPrice}}" />${{ $book->retailPrice }}</td>
...
<button type="submit" class="span3 btn btn-cart btn-lg btn-danger pull-right" style="padding-right:50px;">Add Items to Cart</button>
