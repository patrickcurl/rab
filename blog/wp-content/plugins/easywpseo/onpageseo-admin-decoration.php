...
elseif (!class_exists('OnPageSEOAdminDecoration'))
{
	class OnPageSEOAdminDecoration
	{
		// Instance Variables
		var $options = array();
		...
		function OnPageSEOAdminDecoration($options)
		{
...
//##################################################################
			...
			$this->keyword = trim(stripslashes($_REQUEST['mainkeyword']));
