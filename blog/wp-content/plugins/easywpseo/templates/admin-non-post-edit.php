...
<input type="hidden" name="nonpost-action" value="edit" />
			...
			<div id="poststuff" class="metabox-holder<?php echo 2 == $screen_layout_columns ? ' has-right-sidebar' : ''; ?>">
				...
				<div id="post-body" class="has-sidebar">
					<div id="post-body-content" class="has-sidebar-content">
						...
						<p>
							<input type="submit" value="<?php _e('Update', OPSEO_TEXT_DOMAIN);?>" class="button-primary" name="opseo-submit-button" id="opseo-submit-button" /> <a href="admin.php?page=onpageseo-url-analyzer" class="button"><?php _e('Cancel', OPSEO_TEXT_DOMAIN);?></a>
						</p>
					</div>
				</div>
				<br class="clear"/>
