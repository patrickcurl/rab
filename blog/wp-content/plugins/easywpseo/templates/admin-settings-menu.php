		...
		<div id="opseo-tabs" class="inside">
			...
			<div id="opseo-keyword" class="opseo-tabs-panel">
				...
				<tr valign="top" style="background-color:rgb(238,238,238);">
				<th scope="row"><label for="onpageseo_options[lsi_keyword_api_key_bing]"><?php _e('Bing API Key', OPSEO_TEXT_DOMAIN);?> </label></th>
				<td><input type="text" name="onpageseo_options[lsi_keyword_api_key_bing]" value="<?php echo $this->options['lsi_keyword_api_key_bing'];?>" class="large-text" /><br /><em><?php _e('Enter your Bing API account key.', OPSEO_TEXT_DOMAIN);?></em><a href="http://easywpseo.com/pdf/bing-search-api-account-key.pdf" title="<?php __('Bing Search API Account Key Help', OPSEO_TEXT_DOMAIN);?>" target="_blank"><img src="<?php echo OPSEO_PLUGIN_URL;?>/images/help.png" alt="<?php __('Help', OPSEO_TEXT_DOMAIN);?>" title="<?php __('Help', OPSEO_TEXT_DOMAIN);?>" /></a></td>
				</tr>
