<?php
    ...
    */
    ...
    class opseoTextStatistics {
        ...
        function opseoTextStatistics($strEncoding='') {
            $this->__construct($strEncoding);
        }
	   ...
	   function flesch_kincaid_reading_ease_level($score)
	   {
		if($score >= 90) { return('Very Easy'); }
		elseif($score >= 80 && $score <= 89) { return('Easy'); }
		elseif($score >= 70 && $score <= 79) { return('Fairly Easy'); }
		elseif($score >= 60 && $score <= 69) { return('Standard'); }
		elseif($score >= 50 && $score <= 59) { return('Fairly Difficult'); }
		elseif($score >= 30 && $score <= 49) { return('Difficult'); }
		elseif($score <= 29) { return('Very Confusing'); }
	   }
...
function str_Ireplace($needle, $replacement, $haystack) {
   ...
   return $haystack;
         ...
         */
        function substring($strText, $intStart, $intLength) {
            $strSubstring = '';
