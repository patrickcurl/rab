...
class PeThemeAdmin {
	...
	public function admin_init() {
		...
		if ($this->options->adminThumbs === "yes") {
			...
			$types = array_merge(array("post","page"),array_keys(PeGlobal::$config["post_types"]));
	...
	public function edit_form_after_title() {
		...
		if (empty($options)) {
			...
			if (count($posts) > 0) {
				...
				//$options = array_merge(array(__pe("Quick Navigation") => ""),$options);
			} 
		}
	...
	public function registerAssets() {
		...
		PeThemeAsset::addScript("framework/js/admin/jquery.theme.admin.js",array('jquery','jquery-ui-core','jquery-ui-tabs', 'jquery-ui-sortable','jquery-ui-tooltip','pe_theme_utils'),"pe_theme_admin");
