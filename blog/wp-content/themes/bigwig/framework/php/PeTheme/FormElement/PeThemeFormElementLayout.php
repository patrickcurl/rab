...
class PeThemeFormElementLayout extends PeThemeFormElement {
	...
	public function registerAssets() {
		...
		PeThemeAsset::addScript("framework/js/admin/jquery.theme.field.layout.js",array("pe_theme_utils","jquery-ui-sortable","json2"),"pe_theme_field_layout");
	...
	protected function template() {
		...
		$buttonLabel = __pe("Add New Block");
		$cancelLabel = __pe('Close Blocks');
