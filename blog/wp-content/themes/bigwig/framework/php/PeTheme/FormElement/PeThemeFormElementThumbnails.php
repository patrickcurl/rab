...
EOT;
	...
	protected function addTemplateValues(&$data) {
		...
		$buffer .= sprintf('<div class="pe-theme-editor" data-nonce="%s" data-id="%s" data-scale="%s" data-w="%s" data-h="%s" data-pw="%s" data-ph="%s"><img src="%s"/><div class="pe-controls"><input type="button" id="pe-theme-done" class="ob_button" value="%s"/><input type="button" id="pe-theme-cancel" class="ob_button" value="%s"/></div></div>',$this->data["nonce"],$this->data["id"],$this->data["width"]/$pw,$w,$h,$pw,$ph,$img,__pe("save"),__pe("cancel"));
