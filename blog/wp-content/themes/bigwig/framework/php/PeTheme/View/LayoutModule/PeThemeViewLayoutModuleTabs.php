...
class PeThemeViewLayoutModuleTabs extends PeThemeViewLayoutModuleContainer {
	...
	public function tooltip() {
		return __pe("Use this block to add horizontally tabbed content to your layout. Each tab consists of a title and body content. The body content is only displayed when the title is clicked by the user, except in the case of the first tab, which will be open upon page load.");
	}
